...
class PassBackend(PasswordBackend):
    ...
    @classmethod
    def create(cls, settings: Optional[PassBackendSettings] = None) -> "PassBackend":
    ...
    def _run_pass(self, args: List[str], input_data: Optional[str] = None) -> subprocess.CompletedProcess:
